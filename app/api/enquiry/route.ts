...
// --- Swear word list (simplified, expand as needed) ---
...
export async function POST(req: Request) {
  try {
    ...
    // Email validation (simple + DNS could be added for real check)
    ...
    if (bannerTypes.length === 0) {
      return NextResponse.json({ error: "Select at least one banner type." }, { status: 400 });
    }
